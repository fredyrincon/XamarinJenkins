...
extern void *mono_aot_module_TestJenkins_iOS_info;
...
extern void *mono_aot_module_TestJenkins_info;

void xamarin_register_modules ()
{
	mono_aot_register_module (mono_aot_module_TestJenkins_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_TestJenkins_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "TestJenkins.iOS.exe";
