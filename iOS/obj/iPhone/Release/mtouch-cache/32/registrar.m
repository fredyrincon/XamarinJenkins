...
void xamarin_create_classes () {
	...
	__xamarin_class_map [2].handle = objc_getClass ("NSParagraphStyle");
	__xamarin_class_map [3].handle = objc_getClass ("NSShadow");
	__xamarin_class_map [4].handle = objc_getClass ("NSTextAttachment");
	__xamarin_class_map [5].handle = objc_getClass ("NSTextContainer");
	...
	__xamarin_class_map [44].handle = objc_getClass ("UIPageViewController");
	...
	__xamarin_class_map [58].handle = objc_getClass ("UICollectionViewFlowLayout");
	...
	__xamarin_class_map [68].handle = objc_getClass ("CTTelephonyNetworkInfo");
	...
	__xamarin_class_map [84].handle = objc_getClass ("NSProcessInfo");
